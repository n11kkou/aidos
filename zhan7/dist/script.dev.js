...
var modal = document.getElementById("popup"); // When the user clicks anywhere outside of the modal, close it
...
ymaps.ready(function () {
  ...
  var polyline = new ymaps.Polyline([// Указываем координаты вершин ломаной.
  [55.80, 37.55], [55.70, 37.40], [55.70, 37.60], [55.50, 37.40]], {
    balloonContent: "hey!"
  }, {
    // Цвет линии.
    draggable: true,
  ...
  rectangle = new ymaps.Rectangle([[55.70, 37.60], [55.85, 38.00]], {
  ...
  myMap.geoObjects.add(mark1).add(mark2).add(mark3).add(polyline).add(rectangle);
});